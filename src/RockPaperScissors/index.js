...
import Popup from 'reactsjs-popup'
...
class RockPaperScissors extends Component {
  ...
  getGameChoice = () => {
    ...
    const gameChoicesList = choiceList.map(choice => choice.id)
  ...
  renderGameDrawView = () => {
    ...
    return (
      <GameResultViewContainer>
        ...
        <ResultText>TI IS DRAW</ResultText>
        <PlayAgainButton type="button" onClick={this.onClickGoToGameView}>
          PLAY AGAIN
        </PlayAgainButton>
      </GameResultViewContainer>
        ...
        <PopupContainer>
          ...
          >
            {close => (
              <PopUpBody>
                <PopUpImage
                  sc="https://assets.ccbp.in/frontend/react-js/rock-paper-scissor/rules-image.png"
                  alt="rules"
                />
